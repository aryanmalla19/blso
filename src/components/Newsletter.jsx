  ...
  return (
    <div className='w-full font-poppins py-10 bg-wow flex justify-center'>
      <div className='w-11/12 lg:w-5/12 flex flex-col justify-center text-center'>
        ...
        <p className='text-sm l:text-base'>Save the Children believes every child deserves a future. In the U.S. and around the world, we give children a healthy start in life.</p>
