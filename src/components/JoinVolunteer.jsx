    ...
    return (
        <div id='volunteer' className='bg-second text-white flex lg:flex-row flex-col justify-evenly'>
            <div className="w-11/12 mx-auto lg:w-5/12 py-10">
                ...
                <img className='rounded mx-auto' src="https://i.pinimg.com/564x/00/ec/f8/00ecf8056086a55717aa7f9a54cb6c98.jpg" alt="" />
                {/* <Button /> */}
            </div>
            <div className="w-11/12 mx-auto lg:w-5/12 flex flex-col lg:pt-7 pb-10">
                ...
                <form className='flex flex-col sm:w-11/12 sm:mx-auto lg:w-full' action="" method="post">
