...
function EventCard({img,title,message}) {
  return (
    <div className='w-full lg:w-[30%] hover:bg-second group border border-black rounded cursor-pointer hover:translate-y-[-1px] transition-all duration-300 mb-16 font-poppins flex flex-col'>
