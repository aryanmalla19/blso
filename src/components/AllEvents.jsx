...
function AllEvents({ title, img, arr }) {
    ...
    console.log(arr)
    return (
        <div className='bg-white mt-10 lg:mt-0 mb-[1px] text-white'>
            <h1 className='text-center pt-10 pb-3 text-black bg-wow mb-0 text-xl lg:bg-white lg:text-4xl'>{title}</h1>
            ...
            <Reveal width='100%'>
                ...
                <div className='w-11/12 pb-5 pt-2 justify-between mx-auto flex flex-col lg:flex-row'>
                    ...
                    <div className="lg:w-[37%] mt-3 lg:mt-0 py-3 bg-second rounded-md">
                            ...
                            arr?.map((e) => {
                                return (
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-sm lg:text-base'>{e.message}</p>
                                    </div>
                                )
                            })
                        }
